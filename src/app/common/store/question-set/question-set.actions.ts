...
export const ActionTypes = {
  ...
  REGISTER_SESSION_SUCCESS: type('[QuestionSet] Register Session Success'),
...
export class RegisterSessionSuccessAction implements Action {
  type = ActionTypes.REGISTER_SESSION_SUCCESS;
  constructor(public payload: QuestionSet) { }
}
